...
- Name: web\opencart-web.spec.ts >> OpenCart customer and shopping flows >> searches for a known product @web @master @sanity @regression
- Location: tests\web\opencart-web.spec.ts:106:7
